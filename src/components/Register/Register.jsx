        ...
        <form className="register__form">
          <div className="register__inputsBlock">
            <label>
              ...
              <input className="register__input" type="text" name="name" placeholder="Имя"/>
            </label>
            <label>
            ...
            <label>
              ...
              <input className="register__input register__input_type_password" type="password" name="password" placeholder="Пароль"/>
              <ErrorMessage />
            </label>
          </div>
          <div className="register__buttonsBlock">
            <button className="register__buttonSubmit">Зарегистрироваться</button>
